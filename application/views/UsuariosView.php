...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="card">
        <div class="card-body">
          <h3>Administración de Usarios</h3>
          <hr>
          <div class="row">
              ...
              <form>
                <div class="row">
                  ...
                  <div class="col">
                    ...
                    <input type="password" class="form-control" id="pass" placeholder="Contraseña" required="true">
                  </div>
                  <div class="col">
                      <div class="form-group">
                        <label for="exampleFormControlSelect1">Perfil</label>
                        <select class="form-control" id="perfil" required="true">
                          <option value="">Seleccione una Opcion...</option>
                          <?php foreach ($perfiles->result() as $key) 
                          {
                           ?>
                           <option value="<?=$key->id_perfil?>"><?=$key->perfil?></option>
                          <?php 
                            } 
                          ?>
                        </select>
...
<script type="text/javascript">
  function crear() {
    ...
    var perfil = $('#perfil').val();
       $.ajax({
        ...
        data: {"nombre" : nombre, "nit" : nit, "correo" : correo, "pass" : pass, "perfil" : perfil},
  ...
  //funcion para eliminar usuario
    function del_user(nit){
       $.ajax({
        // la información a enviar
        // (también es posible utilizar una cadena de datos)
        data: {"nit" : nit},
        // la URL para la petición
        url : '<?=base_url()?>usuarios/borrar_usuario',
        // especifica si será una petición POST o GET
        type : 'POST',
        //mientars
        beforeSend:function(){
...
<script>
    ...
    function cargar_tabla(){
      ...
      var xmlhttp;
            ...
            xmlhttp.open("GET", "<?=base_url()?>usuarios/load_tabla?val=1", true);
            xmlhttp.send();
    }
  </script>
</body>
