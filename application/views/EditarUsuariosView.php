...
<head>
  ...
  <title>Prueba | Editar Usuarios</title>
            ...
            foreach ($data_user->result() as $key) { ?>
                <div class="row">
                  ...
                  <div class="col">
                    ...
                    <input type="password" class="form-control" id="pass" placeholder="Contraseña" required="true" value="<?=$key->password?>">
                  </div>
                  <div class="col">
                  ...
                  <div class="col">
                   <a href="#" class="btn btn-primary" onclick="update_user(<?=$id?>);">Actualizar</a>
                  </div>
                </div>
                <?php 
                  }
  ...
  //funcion para editar usuario
    function update_user(id){
      ...
      $.ajax({
        ...
        data: {"nombre" : nombre, "nit" : nit, "correo" : correo, "pass" : pass, "perfil" : perfil,'id' : id},
